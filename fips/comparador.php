...
// Seleccionar valores de la tabla de la base de datos MySQL
...
<body>
    ...
    <header class="hero">
        ...
        <section class="hero_container container">
            <h1 class="hero_title">Comparación de los diferentes tipos de plantas con la base de datos</h1>
            <p class="hero_paragraph">Aprende a diferenciar las temperaturas de las plantas.</p>
        </section>
    </header>
    ...
    <main>
        <section class="container about">
            ...
            <h2 class="subtitle">¿Qué aprenderás en esta sección?</h2>
            <p class="about_paragraph">Aprenderás a diferenciar las temperaturas de los diferentes tipos de plantas, mediante la base de datos en donde se compararán la temperatura ideal y la que se encuentra.</p>
        ...
        <h1>Temperatura de plantas anuales - Gráfica de barras</h1>
