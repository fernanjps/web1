<?php
    ...
    $host = "212.1.208.199t";            // host = localhost because database hosted on the same server where PHP files are hosted
    $dbname = "u312507976_db61";         // Database name
    $username = "u312507976_db61";          // Database username
    $password = "4Ag1224-1";	    // Database password
